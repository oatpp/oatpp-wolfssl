...
#ifndef oatpp_wolfSSL_server_ConnectionProvider_hpp
#define oatpp_wolfSSL_server_ConnectionProvider_hpp
...
namespace oatpp { namespace wolfssl { namespace server {

/**
 * wolfSSL server connection provider.
...
public:
  ...
  oatpp::async::CoroutineStarterForResult<const provider::ResourceHandle<data::stream::IOStream>&> getAsync() override {
     ...
     *  and then process connections in Asynchronous manner with non-blocking read/write
     */
    throw std::runtime_error("oatpp::wolfssl::server::ConnectionProvider::getConnectionAsync not implemented.");
  }
...
#endif // oatpp_wolfSSL_server_ConnectionProvider_hpp
